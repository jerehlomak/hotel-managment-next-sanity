  ...
  return (
    <div className="container mx-auto">
        <div className="grid md:grid-cols-2 relative gap-5 px-3">
            <div className="h-[540px] relative rounded-xl overflow-hidden">
            ...
            <div className="hidden md:grid grid-cols-2 h-full gap-5">
                {displayPhotos.map((photo, index) => (
                    <div key={index} className="cursor-pointer h-64 rounded-xl overflow-hidden">
                        <Image 
                            src={photo.url}
                ...
                {remainingPhotosCount > 0 && (
                    <div className="cursor-pointer relative h-64 rounded-xl overflow-hidden" onClick={openModal.bind(this, maximumVisiblePhotos)}>
                        <Image 
                            width={150}
                            height={150}
